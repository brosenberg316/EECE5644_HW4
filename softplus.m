...
%softplus Symmetric sigmoid transfer function.
%
% Transfer functions convert a neural network layer's net input into
% its net output.
%	
% A = <a href="matlab:doc softplus">softplus</a>(N) takes an SxQ matrix of S N-element net input column
...
%
%   n = [0; 1; -0.5; 0.5];
%   a = <a href="matlab:doc softplus">softplus</a>(n);
%
% Here is a plot of this transfer function:
%
%   n = -5:0.01:5;
%   plot(n,<a href="matlab:doc softplus">softplus</a>(n))
%   set(gca,'dataaspectratio',[1 1 1],'xgrid','on','ygrid','on')
%
% Here this transfer function is assigned to the ith layer of a network:
%
%   net.<a href="matlab:doc nnproperty.net_layers">layers</a>{i}.<a href="matlab:doc nnproperty.layer_transferFcn">transferFcn</a> = '<a href="matlab:doc softplus">softplus</a>';
%
